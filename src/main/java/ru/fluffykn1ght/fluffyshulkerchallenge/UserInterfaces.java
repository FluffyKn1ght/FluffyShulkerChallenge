...
public class UserInterfaces {
    ...
    public static void openShulkerEditorGui(Player player, ChallengeShulker shulker) {
        openGui(getShulkerEditorGui(player, shulker, ShulkerEditorPage.MAIN), player);
    }
    ...
    private static GuiInventory getShulkersGui(Player player) {
        ...
        items.put(40, new GuiItem(
                ...
                .leftClick(() -> ChatInputHandler.askForChatInput(
                        (AsyncChatEvent event) -> {
                            ...
                            openShulkerEditorGui(player, shulker);
                        },
                        () -> openShulkerGui(player), // TODO
                        player,
                        true,
        ...
        for (ChallengeShulker shulker : plugin.challengeShulkerHandler.shulkers) {
            items.put(i, new GuiItem(
                    ...
                    () -> {})
                    .rightClick(() -> openShulkerEditorGui(player, shulker))
            );
    ...
    private static GuiInventory getShulkerEditorGui(Player player, ChallengeShulker shulker, ShulkerEditorPage page) {
        switch (page) {
            case MAIN -> {
                Map<Integer, GuiItem> items = new HashMap<>();
        ...
        return getShulkerEditorGui(player, shulker, ShulkerEditorPage.MAIN);
    }
}
